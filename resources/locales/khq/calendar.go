...
var calendar = cldr.Calendar{
	...
	FormatNames: cldr.CalendarFormatNames{
		...
		Days: cldr.CalendarDayFormatNames{
			Abbreviated: cldr.CalendarDayFormatNameValue{Sun: "Alh", Mon: "Ati", Tue: "Ata", Wed: "Ala", Thu: "Alm", Fri: "Alj", Sat: "Ass"},
			Narrow:      cldr.CalendarDayFormatNameValue{Sun: "H", Mon: "T", Tue: "T", Wed: "L", Thu: "L", Fri: "L", Sat: "S"},
			Short:       cldr.CalendarDayFormatNameValue{},
			Wide:        cldr.CalendarDayFormatNameValue{Sun: "Alhadi", Mon: "Atini", Tue: "Atalata", Wed: "Alarba", Thu: "Alhamiisa", Fri: "Aljuma", Sat: "Assabdu"},
		},
		Periods: cldr.CalendarPeriodFormatNames{
			Abbreviated: cldr.CalendarPeriodFormatNameValue{},
			Narrow:      cldr.CalendarPeriodFormatNameValue{},
			Short:       cldr.CalendarPeriodFormatNameValue{},
			Wide:        cldr.CalendarPeriodFormatNameValue{AM: "Adduha", PM: "Aluula"},
		},
	},
}
